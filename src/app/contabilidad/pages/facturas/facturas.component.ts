...
export class FacturasComponent implements OnInit {
  ...
  @ViewChild('content') private modalContent: TemplateRef<FacturasComponent>;
  ...
  @ViewChild('dtActions') dtActions!: TemplateRef<FacturasComponent>;
  ...
  listarReporte(){
    ...
    this.dtOptions = {
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.service.getReportFacturas(this.filter_params).subscribe(resp => {
          let data=[], n=0
          if(resp.success){
            if(resp.data){
              resp['data'].forEach(i=>{
      ...
      processing: true,
      searchDelay: 600,
      language: FacturasComponent.spanish_datatables,
