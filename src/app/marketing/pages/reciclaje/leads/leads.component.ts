...
export class LeadsComponent implements OnInit {
  ...
  @ViewChild('modal_control') private modalContent: TemplateRef<LeadsComponent>;
  ...
  @ViewChild('is_check') is_check!: TemplateRef<LeadsComponent>;
  ...
  listInit(){
    this.columns.push(
      ...
      // {title: 'Acc', data: 'seguimiento', orderable: false, searchable: false, defaultContent: '',
      //   ngTemplateRef: {
      //     ref: this.is_check,
      //     context: {
      //       captureEvents: this.captureEventsEmitido.bind(self)
